...
public abstract class LoopTagSupport
     ...
     * @throws java.util.NoSuchElementException  if next() is called but no new elements are available
     * @throws javax.servlet.jsp.JspTagException for other, unexpected exceptions
     */

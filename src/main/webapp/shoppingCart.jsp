                        ...
                        <div class="order-detail-content">
                            ...
                            <div class="cart_navigation">
                                <button class="button continue-shopping" type="button"
                                        onclick="window.location.href='http://localhost:8081/index.jsp'"><span>继续购买</span>
                                </button>
                                <button class="button btn-proceed-checkout" type="button"
                                        onclick="window.location.href='http://localhost:8081/checkOut.action'"><span>全部下单</span>
                                </button>
                            </div>
                        </div>
                    </div>

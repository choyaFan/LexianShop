...
<div id="jtv-mobile-menu" style="left: -250px; width: 250px;">
  <ul class="jtv-mobile-menu">
    ...
    <li><span class="expand fa fa-plus"></span><a href="#">Pages</a>
      <ul>
        <li><span class="expand fa fa-plus"></span><a href="shop_grid.jsp"><span>Shop Grid</span></a>
          <ul>
    ...
    <li><span class="expand fa fa-plus"></span><a href="#">Fruits</a>
      <ul>
        <li><span class="expand fa fa-plus"></span> <a href="shop_grid.jsp"><span>Apples</span></a>
          <ul>
    ...
    <div class="container">
      ...
      <div class="nav-inner">
        ...
        <ul id="nav" class="hidden-xs">
          ...
          <li class="mega-menu"> <a class="level-top" href="shop_grid.jsp"><span>Fruits</span></a>
            ...
            <div class="slider-items-products">
              <div id="category-desc-slider" class="product-flexslider hidden-buttons">
                <div class="slider-items slider-width-col1 owl-carousel owl-theme">
                  ...
                  <!-- Item -->
                  <div class="owl-wrapper-outer"><div class="owl-wrapper"></a>
                    <div class="cat-img-title cat-bg cat-box">
                      <div class="small-tag">标签1</div>
                      <h1 class="cat-heading">模块1</h1>
                      <p>模块1的描述</p>
                    </div>
                  </div></div><div class="owl-item"></a>
                  <div class="cat-img-title cat-bg cat-box">
                    <div class="small-tag">标签2</div>
                    <h1 class="cat-heading">模块2</h1>
                    <p>模块2的描述</p>
                  </div>
                  <!-- End Item -->
            ...
            <div class="toolbar">
              <div class="row">
                <div class="col-md-4 col-sm-8">
                  <div class="btn-group">
                    <div id="grid-view" class="btn btn-default active" data-toggle="tooltip" title="" data-original-title="Grid"><a href="shop_grid.jsp"><i class="fa fa-th"></i></a></div>
                    <div id="list-view" class="btn btn-default" data-toggle="tooltip" title="" data-original-title="List"><a href="#"><i class="fa fa-th-list"></i></a></div>
                  </div>
              ...
              <ul class="products-grid">
                ...
                <li class="item col-lg-4 col-md-4 col-sm-4 col-xs-6">
                  <div class="item-inner">
                    ...
                    <div class="item-info">
                      <div class="info-inner">
                        <div class="item-title"><h6> <a title="Product Title Here" href="single_product.jsp">商品3</a></h6> </div>
                        <div class="item-content">
                          <div class="rating"> <h6>有货</h6>     </div>
                          <div class="item-price">
                            <div class="price-box"> <span class="regular-price"> <span class="price">$155.00</span> </span> </div>
                  ...
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"> <a class="product-image" title="Product Title Here" href="single_product.jsp"> <img alt="Product Title Here" src="images/products/img03.jpg"> </a>
                        <div class="new-label new-top-left">热</div>
                        <div class="jtv-box-hover">
                          <ul class="add-to-links">
                            <li><a class="link-quickview" href="#"><i class="icon-magnifier-add icons"></i><span class="hidden">Quick View</span></a></li>
                            <li><a class="link-wishlist" href="#"><i class="icon-heart icons"></i><span class="hidden">Wishlist</span></a></li>
              ...
              <div class="block-content">
                <ol id="compare-items">
                  <li class="item">
                    ...
                    <a class="jtv-btn-remove" title="Remove This Item" href="#" class="product-name"><i class="fa fa-angle-right"></i>条件1</a> </li>
                  <li class="item">
                    <input type="hidden" value="2174" class="compare-item-id">
                    <a class="jtv-btn-remove" title="Remove This Item" href="#" class="product-name"><i class="fa fa-angle-right"></i>条件2</a> </li>
                  <li class="item">
                    <input type="hidden" value="2174" class="compare-item-id">
                    <a class="jtv-btn-remove" title="Remove This Item" href="#" class="product-name"><i class="fa fa-angle-right"></i>条件3</a> </li>
                </ol>
    ...
    <div class="slider-items-products">
      <div id="brand-logo-slider" class="product-flexslider hidden-buttons">
        <div class="slider-items slider-width-col6 owl-carousel owl-theme">
          ...
          <!-- Item -->
          <div class="owl-wrapper-outer"><div class="owl-wrapper"> </a> </div></div></div></div>
      <!-- End Item -->
...
<footer>
    ...
    <div class="container">
      <div class="row">
        ...
        <address>
          ...
          <p> <i class="fa fa-envelope"></i><span><a href="mailto:email@domain.com">店名</a></span></p><p><i class="fa fa-mobile"></i><span>此店铺电话</span> </p>
          <p><i class="fa fa-mobile"></i><span>店铺电话</span> </p>
        </address>
      </div>
    </div>
  </div>
  ...
  <div class="footer-bottom">
    <div class="container">
      <div class="row">
        <div class="col-sm-5 col-xs-12 coppyright">Copyright © 2017.Company name All rights reserved.<a target="_blank" href="http://sc.chinaz.com/moban/">网页模板</a></div>
...
<a href="#" id="toTop"></span></a></body></html>

    ...
    <div class="container">
        <nav class="navbar navbar-default" role="navigation">
            <div class="navbar-header">
                ...
                <h1 class="navbar-brand"><a href="index.index.html">CAKE SHOP DEMO</a></h1>
            </div>
            <!--navbar-header-->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li><a href="index.index.html" class="active">Home</a></li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu multi-column columns-4">
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <h4>Carrier</h4>
                                    <ul class="multi-column-dropdown">
                                        <li><a class="list" href="products.html">顺丰</a></li>
                                        <li><a class="list" href="products.html">米米乐</a></li>
            ...
            <div class="header-right login">
                ...
                <div id="loginBox">
                    <form id="loginForm">
                        ...
                        <p>New User ? <a class="sign" href="account.html">Sign Up</a> <span><a href="#">Forgot your password?</a></span>
                        </p>
                    </form>
                </div>
            </div>
